...
. Bug fix for running FLaP on a LaTeX file located in the working directory
. Bug fix regarding the extraction of subfiles directives
. Bug fix regarding whitspaces in multiline commands
